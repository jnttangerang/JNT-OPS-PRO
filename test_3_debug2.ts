...
validateDailyClosing(db, { outlet_id: "OUT-A", tanggal: "2026-08-07", actor: { actor_id: "SYSTEM", actor_role: "SYSTEM" } });
console.log('Exceptions in DB:', db.ReconciliationExceptions);
